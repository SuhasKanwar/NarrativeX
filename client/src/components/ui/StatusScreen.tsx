...
export default function StatusScreen({
  ...
  return (
    <div className="status-shell flex min-h-svh flex-col">
      ...
      <main
        id="main-content"
        className="status-content flex flex-1 flex-col items-center justify-center pt-10 pb-20 text-center motion-safe:animate-enter [&_h1]:mt-4 [&_h1]:mb-5 [&_h1]:text-[clamp(2.2rem,5vw,4rem)] [&_h1]:tracking-[-.055em] [&>.button]:mt-8 section-wrap mx-auto w-[calc(100%-40px)] max-w-[1328px] md:w-[calc(100%-64px)] xl:w-[calc(100%-112px)]"
      >
        <div
        ...
        >
          ...
          <h1>{title}</h1>
          <p className="status-description mx-auto max-w-[430px] text-sm leading-8 text-muted">
            {description}
          </p>
        </div>
        {action &&
